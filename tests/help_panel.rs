...
use rusty_textual::node_id_from_ffi;
...
fn help_panel_hides_help_section_when_app_is_inactive() {
    ...
    { let mut __e = rusty_textual::event::EventCtx::default(); let mut __w = rusty_textual::event::WidgetCtx::__from_dispatch(rusty_textual::node_id::NodeId::default(), &mut __e); panel.on_event(&Event::AppFocus(false), &mut __w) };
    ...
    { let mut __e = rusty_textual::event::EventCtx::default(); let mut __w = rusty_textual::event::WidgetCtx::__from_dispatch(rusty_textual::node_id::NodeId::default(), &mut __e); panel.on_event(&Event::AppFocus(true), &mut __w) };
...
fn help_panel_show_help_class_tracks_app_focus_state() {
    ...
    { let mut __w = rusty_textual::event::WidgetCtx::__from_dispatch(rusty_textual::node_id::NodeId::default(), &mut ctx); panel.on_event(&Event::AppFocus(false), &mut __w) };
    assert!(
    ...
    { let mut __w = rusty_textual::event::WidgetCtx::__from_dispatch(rusty_textual::node_id::NodeId::default(), &mut ctx2); panel.on_event(&Event::AppFocus(true), &mut __w) };
    assert!(
...
fn help_panel_help_can_be_driven_via_messages() {
    ...
    { let mut __w = rusty_textual::event::WidgetCtx::__from_dispatch(rusty_textual::node_id::NodeId::default(), &mut clear_ctx); panel.on_message(
        &MessageEvent::new(
            NodeId::default(),
            HelpPanelClearHelp {
                panel: NodeId::default(),
...
fn help_panel_handles_focused_help_pipeline_messages() {
    ...
    { let mut __w = rusty_textual::event::WidgetCtx::__from_dispatch(rusty_textual::node_id::NodeId::default(), &mut set_ctx); panel.on_message(
        &MessageEvent::new(
