...
cleanup. On 2026-09-25 the DirectoryTree symlink gap, the `AppSimulateKey`
class changes, the headless action-map gap and the dropped style-animation
requests were fixed; the other defects are still present.
